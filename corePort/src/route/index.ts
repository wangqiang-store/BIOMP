  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: "notify",
            component: () =>
              import("@/view/operations/notify/index.vue"),
          },
          {
            path: "notify/create",
            name: "notifyCreate",
            component: () =>
              import("@/view/operations/notify/create.vue"),
          },
          {
            path: "notify/details",
            name: "notifyDetails",
            component: () =>
              import("@/view/operations/notify/details.vue"),
          },
        ],
      },
      {
      ...
      },
      {
        path: "config",
        name: "config",
        redirect: "/config/user/core",
        component: () => import("@/view/config/index.vue"),
        children: [
          {
            path: "user/core",
            name: "userCore",
            component: () => import("@/view/config/core/index.vue"),
          },
          {
            path: "user/regional",
            name: "userRegional",
            component: () => import("@/view/config/regional/index.vue"),
          },
          {
            path: "user/base",
            name: "userBase",
