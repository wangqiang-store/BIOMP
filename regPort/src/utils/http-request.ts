...
import { refreshToken } from "@/api/core/sysAreaUser";
...
// 免登陆请求白名单
let WhiteList: Array<string> = ["/sysUserArea/refreshToken"];
...
let errorWhiteList: Array<string> = [
  ...
  "/sysUserArea/checkRepeat",
  "/sysUserArea/checkRepeatByPhone",
  "/sysUserArea/checkRepeatByEmail",
  ...
  (config) => {
    if (getToken() && getRefToken()) {
      ...
      (config.headers as AxiosRequestHeaders)["Authorization"] =
        config.url !== "/sysUserArea/refreshToken" ? getToken() : getRefToken();
    }
