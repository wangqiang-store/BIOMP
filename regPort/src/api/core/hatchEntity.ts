...
//  获取当前区域所有状态的实体
export const getAllEntity = (params: { countyCode: number }) => {
  return httpSerive({
    url: "/inTheEntity/getAllInTheEntityByCode",
    method: "GET",
    params,
  });
};
...
//  获取当前区域所有未关闭的实体
export const getRunEntity = (params: { countyCode: number }) => {
  return httpSerive({
    url: "/inTheEntity/getRunInTheEntityByCode",
    method: "GET",
    params,
  });
};
