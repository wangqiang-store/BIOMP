...
let { entityStatus, entityType, allCodeBaseList } = storeToRefs(commonStore);
...
const onBeforeUpload = (file: any) => {
    const isLt200M = file.size / 1024 / 1024 > 5;
    if (isLt200M) {
...
onMounted(async () => {
    ...
    selectOption.value.incubationBaseId = allCodeBaseList.value as Array<any>;
    // 获取实体类型
