<template>
    <el-table class="reuse-table" :data="tableData" style="width: 100%" :border="isborder" :cell-style="{
            padding: '15px 0'
        }"  header-row-class-name="header" :row-class-name="tableRowClassName" fit :empty-text="emptyText" :max-height="maxHeight" @sort-change="onSortChange">
        <template v-for="item of tableOptions" :key="item.props">
            ...
            item.formatter" :width="item.width" align="center" :sortable="item.sortable " show-overflow-tooltip />
            <!-- 带样式文本框 -->
