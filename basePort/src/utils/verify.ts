...
// 英文开头  英文 数字
export let verifyEN = /^[a-zA-Z][a-zA-Z0-9]*$/;
// 电话
...
// 营业执照编号
export let verifyBusinessLicenseNumber = /^(?:(?![IOZSV])[\dA-Z]){2}\d{6}(?:(?![IOZSV])[\dA-Z]){10}$/;


// 经度
export let verify_longitude = /((^[-]?[0-9])|(^[-]?[2-9]([0-9])?)|(^[-]?[1](([0-7])?)(([0-9])?)))(([.]\d{1,})?){1,2}$/;

// 纬度
export let verify_latitude = /((^[-]?[0-9])|(^[-]?[1-8]([0-9])?))(([.]\d{1,})?){1,2}$/;
